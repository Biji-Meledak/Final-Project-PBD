...
@media  (min-width:768px){
    ...
    <!-- Isi Content -->        
                ...
                <div class="row my-3">
                    <td>
                        ...
                        <div class="container">
                            ...
                            <a href="index.php"><button type="button" class="btn btn-outline"><i class="bi bi-filter-circle"></i></button></a>
		...
		<?php 
		include 'koneksi.php';
		$data = mysqli_query($koneksi,"select id, nama, sum(jumlah) as stok from barang group by id having stok > 5");
