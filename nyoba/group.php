...
@media  (min-width:768px){
    ...
    <!-- Isi Content -->        
                ...
                <div class="row my-3">
                    <td>
                        ...
                        <div class="container">
                            ...
                            <a href="index.php"><button type="button" class="btn btn-outline"><i class="bi bi-filter"></i></button></a>
                            <a href="having.php"><button type="button" class="btn btn-outline"><i class="bi bi-filter-circle"></i></button></a>
                            <a href="join.php"><button type="button" class="btn btn-outline"><i class="bi bi-filter-square"></i></button></a>           
                        </div>
                        <br>
                    </td>
                    <br>
		...
		<?php 
		include 'koneksi.php';
		$data = mysqli_query($koneksi,"select id, id_kategori, nama, satuan, jumlah, harga,(jumlah * harga) as total from barang where satuan in ('buah', 'botol')");
