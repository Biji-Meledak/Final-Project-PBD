...
@media  (min-width:768px){
    ...
    <!-- Isi Content -->        
                ...
                <div class="row my-3">
                    <td>
                        ...
                        <div class="container">
                            ...
                            <a href="join.php"><button type="button" class="btn btn-outline"><i class="bi bi-filter-square"></i></i></button></a>      
                        </div>
                        <br>
                    </td>
                    <br>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select id, id_kategori, nama, satuan, jumlah, harga,(jumlah * harga) as total from barang");
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit.php?id=<?php echo $d['id']; ?>"><i class="bi bi-pencil-square"></i></a>
					<a href="hapus.php?id=<?php echo $d['id']; ?>"><i class="bi bi-trash-fill"></i></a>
				</td>
			</tr>
			<?php 
			}
