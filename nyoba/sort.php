...
@media  (min-width:768px){
    ...
    <!-- Isi Content -->          
                ...
                <div class="row my-3">
                    <td>
                        ...
                        <div class="container">
                            ...
                            <a href="index.php"><button class="btn"><i class="bi bi-chevron-expand"></i></button></a>
		...
		<?php 
		include 'koneksi.php';
		$data = mysqli_query($koneksi,"select id, id_kategori, nama, satuan, jumlah, harga, (jumlah * harga) as total from barang order by nama asc");
